...
class FakeRepository:
	...
	def update_file_outputs(self, job_id: UUID, source_file_path, output_test_path, output_metadata_path) -> None:
...
def test_rerun_rehydrates_enum_fields(monkeypatch) -> None:
	...
	def _fake_generate(request: GenerationRequest, initial_warnings: list[str], idempotency_key: str | None):
