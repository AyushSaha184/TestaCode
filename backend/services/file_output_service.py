...
class FileOutputService:
    ...
    def write_outputs(
        ...
        *,
        ...
        storage_base_path = f"sessions/{safe_session}/{safe_language}/{feature_name}"
        storage_test_path = f"{storage_base_path}/test_{feature_name}.{ext}"
        storage_metadata_path = f"{storage_base_path}/test_{feature_name}.json"
        warnings: list[str] = []
        ...
        try:
            ...
            if self.storage_service and self.storage_service.is_configured():
                ...
                warnings.append("Supabase storage is not configured; artifacts stored in local fallback only")
            ...
            return FileOutputResult(
                ...
                test_file_path=output_test_path,
                metadata_file_path=output_metadata_path,
                test_file_url=output_test_url,
                metadata_file_url=output_metadata_url,
